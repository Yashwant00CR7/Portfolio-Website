    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            <span className="text-stone-900 dark:text-stone-100 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-cyan-600 transition-all duration-300">YK.</span>
          </button>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <button
                  key={link.name}
                  onClick={link.action}
                  className={`text-sm font-medium transition-colors relative group cursor-scale ${
                    isActive ? 'text-stone-900 dark:text-stone-100' : 'text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100'
                  }`}
                >
                  {link.name}
